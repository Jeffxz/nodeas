...
const uint32_t nodeas_NewObjectNodeas_object_get = 227;
const uint32_t nodeas_NewObjectNodeas_size_get = 228;
const uint32_t native_script_function_flash_sampler_isGetterSetter = 233;
const uint32_t native_script_function_flash_sampler__getInvocationCount = 234;
const uint32_t native_script_function_flash_sampler_getSampleCount = 238;
const uint32_t native_script_function_flash_sampler_getSamples = 239;
const uint32_t native_script_function_flash_sampler_getMemberNames = 240;
const uint32_t native_script_function_flash_sampler_getSize = 241;
const uint32_t native_script_function_flash_sampler__setSamplerCallback = 242;
const uint32_t native_script_function_flash_sampler_sampleInternalAllocs = 245;
const uint32_t native_script_function_flash_sampler_pauseSampling = 246;
const uint32_t native_script_function_flash_sampler_stopSampling = 247;
const uint32_t native_script_function_flash_sampler_startSampling = 248;
const uint32_t native_script_function_flash_sampler_clearSamples = 249;
const uint32_t flash_sampler_NewObjectSample_object_get = 256;
const uint32_t flash_sampler_NewObjectSample_size_get = 257;
const uint32_t flash_trace_Trace_setLevel = 263;
const uint32_t flash_trace_Trace_getLevel = 264;
const uint32_t flash_trace_Trace_setListener = 265;
const uint32_t flash_trace_Trace_getListener = 266;
const uint32_t flash_utils_Dictionary_private_init = 270;
const uint32_t avmplus_JObject_create = 277;
const uint32_t avmplus_JObject_createArray = 278;
const uint32_t avmplus_JObject_toArray = 279;
const uint32_t avmplus_JObject_constructorSignature = 280;
const uint32_t avmplus_JObject_methodSignature = 281;
const uint32_t avmplus_JObject_fieldSignature = 282;
